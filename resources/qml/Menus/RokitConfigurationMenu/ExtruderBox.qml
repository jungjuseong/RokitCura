...
Item {
    ...
    Rectangle {
        ...
        Rectangle { //Input field for pre-heat temperature.
            ...
            {
                return (extruderTemperature.properties.maximum_value != "None" && extruderTemperature.properties.maximum_value <  Math.floor(preheatTemperatureInput.text)) ? true : false
            }
            enabled:  {
            ...
            TextInput {
                ...
                text: (!extruderTemperature.properties.value) ? "" : extruderTemperature.properties.value;
            }
        }
