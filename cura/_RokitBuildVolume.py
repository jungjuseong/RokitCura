...
class BuildVolume(SceneNode):
    ...
    def rebuild(self) -> None:
        ...
        self._build_dish_shape = self._global_container_stack.getProperty("machine_build_dish_shape", "value")
        self._build_dish_width = self._global_container_stack.getProperty("machine_build_dish_width", "value")
        self._build_dish_depth = self._global_container_stack.getProperty("machine_build_dish_depth", "value")
        self._build_dish_height = self._global_container_stack.getProperty("machine_build_dish_height", "value")
